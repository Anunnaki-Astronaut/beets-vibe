...
- **Rich DJ Metadata**: BPM analysis, musical key detection, Open Key and Camelot fields
- **Enhanced UI**: Match confidence display and multi-source tagging
- **Lidarr Integration**: Seamless workflow with Lidarr for automated downloading and processing